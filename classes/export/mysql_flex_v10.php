    ...
    public static function export($imei, array $telemetry, $prefix = false)
    {
        ...
        foreach ($telemetry as $t)
        {
            ...
            try
            {
                ...
                $stmt->bindValue(33, $t->getStateInImp2(), PDO::PARAM_INT);
                $stmt->bindValue(34, $t->getTemp1(), PDO::PARAM_INT);
                $stmt->bindValue(35, $t->getTemp2(), PDO::PARAM_INT);
                $stmt->bindValue(36, $t->getTemp3(), PDO::PARAM_INT);
                $stmt->bindValue(37, $t->getSpeed(), PDO::PARAM_INT);
                $stmt->bindValue(38, $t->getFrequency1(), PDO::PARAM_INT);
                $stmt->bindValue(39, $t->getMotochas(), PDO::PARAM_INT);
                $stmt->bindValue(40, $t->getPower(), PDO::PARAM_INT);
                $stmt->bindValue(41, $t->getReserv(), PDO::PARAM_INT);
