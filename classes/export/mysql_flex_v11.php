            ...
            try
            {
                $stmt = $db->prepare('
                    INSERT INTO telemetry_events
                        (`IMEI`, `reqType`, `numPage`, `Code`, `Module1GSM`, `Module1USB`, `Module1Watch`, `Module1SIM`, `Module1Network`, `Module1Roaming`, `Module1Engine`, `Time`, `GSM`, `LastTime`, `Lat`, `Lon`, `Alt`, `Course`, `Mileage`, `CAN_EngineTurns`, `CAN_Temp`, `CAN_EngineLoad`, `CAN_Speed`, `CAN_AxleLoad1`, `CAN_AxleLoad2`, `CAN_AxleLoad3`, `CAN_AxleLoad4`, `CAN_AxleLoad5`, `StateU_Ain1`, `StateU_Ain2`, `StateU_Ain3`, `StateInImp2`, `Temp1`, `Temp2`, `Temp3`, `Speed`, `Frequency1`, `Motochas`, `Power`, `Reserv`, `ATemp1`, `ATemp2`, `ATemp3`, `ATemp4`, `ATemp5`, `ATemp6`, `ATemp7`, `ATemp8`, `ATemp9`, `ATemp10`, `ATemp11`, `ATemp12`, `ATemp13`, `ATemp14`, `ATemp15`, `ATemp16`)
                    VALUES (
                        ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                    ');
                ...
                $stmt->bindValue(41, $t->getATemp1(), PDO::PARAM_INT);
                $stmt->bindValue(42, $t->getATemp2(), PDO::PARAM_INT);
                $stmt->bindValue(43, $t->getATemp3(), PDO::PARAM_INT);
                $stmt->bindValue(44, $t->getATemp4(), PDO::PARAM_INT);
                $stmt->bindValue(45, $t->getATemp5(), PDO::PARAM_INT);
                $stmt->bindValue(46, $t->getATemp6(), PDO::PARAM_INT);
                $stmt->bindValue(47, $t->getATemp7(), PDO::PARAM_INT);
                $stmt->bindValue(48, $t->getATemp8(), PDO::PARAM_INT);
                $stmt->bindValue(49, $t->getATemp9(), PDO::PARAM_INT);
                $stmt->bindValue(50, $t->getATemp10(), PDO::PARAM_INT);
                $stmt->bindValue(51, $t->getATemp11(), PDO::PARAM_INT);
                $stmt->bindValue(52, $t->getATemp12(), PDO::PARAM_INT);
                $stmt->bindValue(53, $t->getATemp13(), PDO::PARAM_INT);
                $stmt->bindValue(54, $t->getATemp14(), PDO::PARAM_INT);
                $stmt->bindValue(55, $t->getATemp15(), PDO::PARAM_INT);
                $stmt->bindValue(56, $t->getATemp16(), PDO::PARAM_INT);
